...
IL_003e:
	{
		int32_t L_6 = V_0;
		Queue_1_SetCapacity_m651CD813B5B37335E6EEF9254E7BA5536FC63D8C(__this, L_6, il2cpp_rgctx_method(method->klass->rgctx_data, 5));
	}
...
IL_0045:
	{
		...
		int32_t* L_10 = (int32_t*)(&__this->____tail);
		Queue_1_MoveNext_mC1BA4D1EEC1214AA74EF0A431B61D0CA2080A520(__this, L_10, il2cpp_rgctx_method(method->klass->rgctx_data, 7));
		int32_t L_11 = __this->____size;
		__this->____size = ((int32_t)il2cpp_codegen_add(L_11, 1));
		int32_t L_12 = __this->____version;
		__this->____version = ((int32_t)il2cpp_codegen_add(L_12, 1));
...
{
	{
		...
		memset((&L_0), 0, sizeof(L_0));
		Enumerator__ctor_mA096A26E50524C85CB5098E6452556E96E4B33D5((&L_0), __this, il2cpp_rgctx_method(method->klass->rgctx_data, 9));
		return L_0;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR StringData_tCCBB20271B9830E5BF42E214AE2AA9AF33C2EEF7 Queue_1_Dequeue_mEE2B443D3769433317A0A91368901C65BD355349_gshared (Queue_1_t973E4BD80BC9256B89CF8D4E26520AADF7788306* __this, const RuntimeMethod* method) 
{
	...
	{
		Queue_1_ThrowForEmptyQueue_m988094467488DD0F11B893C713B3548172B49BC3(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 11));
	}
...
IL_000a:
	...
	}
	{
		...
		int32_t L_6 = __this->____size;
		int32_t L_7;
		L_7 = Array_IndexOf_TisStringData_tCCBB20271B9830E5BF42E214AE2AA9AF33C2EEF7_m99362871FE87DFFDC45474C3CA59311B5CFB9A14(L_3, L_4, L_5, L_6, il2cpp_rgctx_method(method->klass->rgctx_data, 12));
		return (bool)((((int32_t)((((int32_t)L_7) < ((int32_t)0))? 1 : 0)) == ((int32_t)0))? 1 : 0);
	}
...
IL_0037:
	{
		...
		int32_t L_12 = __this->____head;
		int32_t L_13;
		L_13 = Array_IndexOf_TisStringData_tCCBB20271B9830E5BF42E214AE2AA9AF33C2EEF7_m99362871FE87DFFDC45474C3CA59311B5CFB9A14(L_8, L_9, L_10, ((int32_t)il2cpp_codegen_subtract(((int32_t)(((RuntimeArray*)L_11)->max_length)), L_12)), il2cpp_rgctx_method(method->klass->rgctx_data, 12));
		if ((((int32_t)L_13) >= ((int32_t)0)))
		{
			goto IL_0075;
		}
	}
	{
		...
		int32_t L_16 = __this->____tail;
		int32_t L_17;
		L_17 = Array_IndexOf_TisStringData_tCCBB20271B9830E5BF42E214AE2AA9AF33C2EEF7_m99362871FE87DFFDC45474C3CA59311B5CFB9A14(L_14, L_15, 0, L_16, il2cpp_rgctx_method(method->klass->rgctx_data, 12));
		return (bool)((((int32_t)((((int32_t)L_17) < ((int32_t)0))? 1 : 0)) == ((int32_t)0))? 1 : 0);
	}
