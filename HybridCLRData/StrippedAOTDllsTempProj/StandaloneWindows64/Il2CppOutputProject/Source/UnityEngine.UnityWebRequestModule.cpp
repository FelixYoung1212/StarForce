...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR String_t* WebRequestUtils_MakeInitialUrl_m30A37413A904FEB4E4E45607E929B4E90ECE044C (String_t* ___0_targetUrl, String_t* ___1_localUrl, const RuntimeMethod* method) 
{
	...
	bool V_9 = false;
	bool V_10 = false;
	FormatException_tCD210E92627903FFEDAAA706C08FB6222B4D012B* V_11 = NULL;
	bool V_12 = false;
...
IL_0041:
	...
	{
		Regex_tE773142C2BE45C5D362B0F815AFF831707A51772* L_14 = ((WebRequestUtils_t23F1FB533DBFDA3BE5624D901D535B4C6EFAD443_StaticFields*)il2cpp_codegen_static_fields_for(WebRequestUtils_t23F1FB533DBFDA3BE5624D901D535B4C6EFAD443_il2cpp_TypeInfo_var))->___domainRegex;
		V_8 = (bool)((((RuntimeObject*)(Regex_tE773142C2BE45C5D362B0F815AFF831707A51772*)L_14) == ((RuntimeObject*)(RuntimeObject*)NULL))? 1 : 0);
		bool L_15 = V_8;
		if (!L_15)
		{
			goto IL_006e;
	...
	{
		Regex_tE773142C2BE45C5D362B0F815AFF831707A51772* L_16 = (Regex_tE773142C2BE45C5D362B0F815AFF831707A51772*)il2cpp_codegen_object_new(Regex_tE773142C2BE45C5D362B0F815AFF831707A51772_il2cpp_TypeInfo_var);
		Regex__ctor_m082970AA73B8236360F0CA651FA24A8D1EBF89CD(L_16, _stringLiteral665437E312D2053C5919723E2E7EA49D0A2ADE1F, NULL);
		((WebRequestUtils_t23F1FB533DBFDA3BE5624D901D535B4C6EFAD443_StaticFields*)il2cpp_codegen_static_fields_for(WebRequestUtils_t23F1FB533DBFDA3BE5624D901D535B4C6EFAD443_il2cpp_TypeInfo_var))->___domainRegex = L_16;
		Il2CppCodeGenWriteBarrier((void**)(&((WebRequestUtils_t23F1FB533DBFDA3BE5624D901D535B4C6EFAD443_StaticFields*)il2cpp_codegen_static_fields_for(WebRequestUtils_t23F1FB533DBFDA3BE5624D901D535B4C6EFAD443_il2cpp_TypeInfo_var))->___domainRegex), (void*)L_16);
	}

IL_006e:
	{
		Regex_tE773142C2BE45C5D362B0F815AFF831707A51772* L_17 = ((WebRequestUtils_t23F1FB533DBFDA3BE5624D901D535B4C6EFAD443_StaticFields*)il2cpp_codegen_static_fields_for(WebRequestUtils_t23F1FB533DBFDA3BE5624D901D535B4C6EFAD443_il2cpp_TypeInfo_var))->___domainRegex;
		String_t* L_18 = ___0_targetUrl;
		NullCheck(L_17);
		bool L_19;
		L_19 = Regex_IsMatch_m7E96E666FBE7259D7638A3A6A21BE824D2406F49(L_17, L_18, NULL);
		V_9 = L_19;
		bool L_20 = V_9;
		if (!L_20)
		{
	...
	}
	{
		...
		String_t* L_24;
		L_24 = String_Concat_m8855A6DE10F84DA7F4EC113CADDB59873A25573B(L_22, _stringLiteral6A1D52382547009AB732F651FE2CA42F1BBA769A, L_23, NULL);
		___0_targetUrl = L_24;
		V_0 = (bool)1;
	}
...
IL_0097:
	...
	try
	{
		...
		{
			String_t* L_27 = ___0_targetUrl;
			NullCheck(L_27);
			Il2CppChar L_28;
			L_28 = String_get_Chars_mC49DF0CD2D3BE7BE97B3AD9C995BE3094F8E36D3(L_27, 0, NULL);
			G_B14_0 = ((((int32_t)((((int32_t)L_28) == ((int32_t)((int32_t)46)))? 1 : 0)) == ((int32_t)0))? 1 : 0);
			goto IL_00b4_1;
		}
...
CATCH_00c4:
	{
		...
		V_11 = L_32;
		FormatException_tCD210E92627903FFEDAAA706C08FB6222B4D012B* L_33 = V_11;
		V_3 = L_33;
...
IL_00cd:
	{
		Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E* L_34 = V_2;
		il2cpp_codegen_runtime_class_init_inline(Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E_il2cpp_TypeInfo_var);
		bool L_35;
		L_35 = Uri_op_Equality_mD7D7AAB7023C0873B37D8B8C7195BEF34002A194(L_34, (Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E*)NULL, NULL);
		V_12 = L_35;
		bool L_36 = V_12;
		if (!L_36)
		{
	...
	try
	{
		Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E* L_37 = V_1;
		...
		Uri__ctor_mD7EC916948CBFE71F80298DDA6E4209724958B09(L_39, L_37, L_38, NULL);
		V_2 = L_39;
		V_0 = (bool)1;
		goto IL_00ec;
	}
...
CATCH_00e8:
	{
		FormatException_tCD210E92627903FFEDAAA706C08FB6222B4D012B* L_40 = ((FormatException_tCD210E92627903FFEDAAA706C08FB6222B4D012B*)IL2CPP_GET_ACTIVE_EXCEPTION(FormatException_tCD210E92627903FFEDAAA706C08FB6222B4D012B*));;
		FormatException_tCD210E92627903FFEDAAA706C08FB6222B4D012B* L_41 = V_3;
		IL2CPP_POP_ACTIVE_EXCEPTION(Exception_t*);
		IL2CPP_RAISE_MANAGED_EXCEPTION(L_41, ((RuntimeMethod*)il2cpp_codegen_initialize_runtime_metadata_inline((uintptr_t*)&WebRequestUtils_MakeInitialUrl_m30A37413A904FEB4E4E45607E929B4E90ECE044C_RuntimeMethod_var)));
	}

IL_00ec:
	{
		Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E* L_42 = V_2;
		String_t* L_43 = ___0_targetUrl;
		bool L_44 = V_0;
		String_t* L_45;
		L_45 = WebRequestUtils_MakeUriString_mC95B57536DF28E6A9FE768A31BD7CE6AC976D837(L_42, L_43, L_44, NULL);
		V_5 = L_45;
		goto IL_00f8;
	}
...
IL_0029:
	{
		...
		NullCheck(L_10);
		bool L_11;
		L_11 = String_Contains_m7A165D1B2CDCE967F4522BA710CE7FA05EFA2982(L_10, _stringLiteral6C066B34F4DB79023C0642AFBC43B25A5327F710, 4, NULL);
		V_5 = L_11;
		bool L_12 = V_5;
		if (!L_12)
		{
	...
	}
	{
		...
		NullCheck(L_13);
		bool L_14;
		L_14 = String_Contains_m182EA83138C61663D7F45F699EE295F0E70FD581(L_13, ((int32_t)43), 4, NULL);
		V_6 = L_14;
		bool L_15 = V_6;
		if (!L_15)
		{
	...
	}
	{
		...
		NullCheck(L_18);
		bool L_19;
		L_19 = String_StartsWith_mA2A4405B1B9F3653A6A9AA7F223F68D86A0C6264(L_18, _stringLiteral9A62305734B1A5D8C56B0791FEB96BCDDD1CD15E, 4, NULL);
...
IL_0107:
	...
	}
	{
		...
		NullCheck(L_58);
		bool L_59;
		L_59 = String_Contains_m7A165D1B2CDCE967F4522BA710CE7FA05EFA2982(L_58, _stringLiteral6C066B34F4DB79023C0642AFBC43B25A5327F710, 4, NULL);
		V_14 = L_59;
		bool L_60 = V_14;
		if (!L_60)
		{
...
IL_0162:
	{
		...
		NullCheck(L_63);
		bool L_64;
		L_64 = String_StartsWith_mA2A4405B1B9F3653A6A9AA7F223F68D86A0C6264(L_63, _stringLiteral225454A90D745E7A7A5DE5C12169566FBC05370D, 4, NULL);
		if (!L_64)
		{
			goto IL_018c;
		}
...
IL_01f0:
	{
		...
		NullCheck(L_91);
		bool L_92;
		L_92 = String_Contains_m7A165D1B2CDCE967F4522BA710CE7FA05EFA2982(L_91, _stringLiteral6C066B34F4DB79023C0642AFBC43B25A5327F710, 4, NULL);
		V_16 = L_92;
		bool L_93 = V_16;
		if (!L_93)
		{
